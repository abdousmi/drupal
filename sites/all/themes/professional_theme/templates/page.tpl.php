...
<div id="wrapper">
  <header id="header" role="banner">
    <?php if ($logo): ?><div id="logo"><a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img style="opacity:0.15;filter:alpha(opacity=60)" src="<?php print $logo; ?>" width="60" height="60"/></a></div><?php endif; ?>
